...
module.exports = {
    getEntries: async(req, res) => {
        ...
        try {
            ...
            res.render('Entries.ejs', { Entries: journalEntries, left: unreadEntries, user: req.user }) // TODO: Remove journalEntries 
        } catch (err) {
            console.log(err)
        }
    },
    createEntry: async(req, res) => {
        try {
            await Entry.create({ title: req.body.titleItem, entry: req.body.entryItem, read: false, userId: req.user.id })
